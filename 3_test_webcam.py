...
SEQUENCE_LENGTH = 45
THRESHOLD = 0.7  # Só mostra a predição se a confiança for > 70%
...
with PoseLandmarker.create_from_options(pose_options) as pose_landmarker, \
    ...
    while cap.isOpened():
        ...
        # Mantém apenas os últimos frames
        ...
        if len(sequence) == SEQUENCE_LENGTH:
            ...
            if (confidence > THRESHOLD):
                ...
                print("Text:", text, confidence)

            # Exibe só as 3 ultimas palavras
            cv2.putText(frame, current_text, (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
